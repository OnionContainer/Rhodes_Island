...
export class Profile{
    ...
    public get prepTime():number{return this._prepTime;}
    public get afterTime():number{return this._afterTime;}
    public get breakthrough():number{return this._breakthrough;}
    constructor(){
