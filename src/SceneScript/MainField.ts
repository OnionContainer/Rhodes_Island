...
import {Grids} from "./Ground"
import Doctor from "./Doctor"
import Operator from "../GameObj/Operator";
import {Struc} from "../DataStructure"
const {log} = console;
const gameSet_json:string = "./Database/GameSet.json", enemyDatabase:string = "./Database/EnemyDatabase.json"
type timeNode = {time:number, type:any, path:number[][]}


export default class GameField extends ui.MainFieldUI{
    /**
     * sb
     */
    public grids:Grids
